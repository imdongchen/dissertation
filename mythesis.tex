...
\input{02-Literature/1_task}
\input{02-Literature/2_collaboration}
\input{02-Literature/3_system}

\chapter{CAnalytics: Tool Supporting \\ Collaborative Information Analysis}
\input{03-System/1_task_analysis}
\input{03-System/2_design_objectives}
\input{03-System/3_system_features}
\input{03-System/4_implementation}
\input{03-System/5_summary}

\chapter{The First Classroom Study}

\input{04-Study_one/1_problem_statement}
\input{04-Study_one/2_class_settings}
\input{04-Study_one/3_system}
\input{04-Study_one/3_result}
\input{04-Study_one/4_discussion}

\chapter{The second Classroom Study}
\input{05-Study_two/1_problem_statement}
\input{05-Study_two/2_system}
\input{05-Study_two/3_class_settings}
\input{05-Study_two/4_result}
\input{05-Study_two/5_discussion}

\chapter{Discussion and Conclusion}
\input{06-Discussion/1_method}
\input{06-Discussion/2_lessons}
\input{06-Discussion/3_design-implication}
